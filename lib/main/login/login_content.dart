...
import 'package:app_desafio_inovacao/main/home/home_page.dart';
import 'package:app_desafio_inovacao/main/register_user/register_user_page.dart';
...
class _LoginContentState extends State<LoginContent> {
  ...
  _submit() async {
    ...
    widget.loginBloc.dispatch(
        ButtonPressed(prefs: prefs, email: _email.text, password: _pass.text));
  }
